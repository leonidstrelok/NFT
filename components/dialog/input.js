            ...
            <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-[#24274D] dark:bg-white shadow-xl">
              ...
              <div className="flex flex-col space-y-2">
                <div className="flex flex-row">
                  <div className="flex-grow text-white dark:text-gray-800 text-2xl font-semibold">
                    ⚡ Process to Resell
                  </div>
                  <button
                    className="flex-none text-[#8488B7] text-2xl"
                    onClick={props.closePriceModal}
                  >
              ...
              <div className="mt-2">
                <button
                  ...
                  onClick={() =>
                    props.children.resellFucnction(
                      props.children.item,
                      newPrice,
                    )
                  }
