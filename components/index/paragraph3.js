...
export default function Paragraph3() {
  ...
  const sellNftDetails = [
    ...
    },
    {
      ...
      description:
        'Once you set up wallet of choice, connect it to opensky by clicking the wallet icon in the top right corner. Learn about the wallets we support',
    },
    {
      iconUrl: '/assets/svg/sell-nft-icon4',
      title: 'List Items For Sale',
      description:
        'Sell your items with price and also have ability to cancel anytime from sale and edit price can work at etherum and bnb and polygon net, any network with solidity',
    },
  ];
    ...
    <div className="w-full h-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mx-8 mt-8 sm:mx-16 sm:mt-16 lg:mx-[9vw] lg:mt-[9vw]">
        {sellNftDetails.map((item, index) => (
          ...
          >
            <img src={item.iconUrl + (themeMode ? '.svg' : '-dark.svg')} alt="sell-nft" />
