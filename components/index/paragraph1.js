  ...
  return (
    <div className="flex flex-col space-y-8 md:flex-row md:space-y-0 md:items-center m-8 sm:m-16 ">
        ...
        <div className="flex-1 flex flex-row gap-4 mt-[4vw]">
          <div className="">
            <Link href="./categories" passHref legacyBehavior>
              <button className="rounded-full bg-gradient-to-b from-[#3461FF] to-[#8454EB] text-white text-xs sm:text-base px-6 sm:px-10 py-1.5 sm:py-2 shadow-lg">
                Collection
              </button>
            </Link>
          </div>
      ...
      <div className="flex-1 flex items-center">
        <img
          src="/assets/svg/bg-ethereum-nft.svg"
          alt="BgEthereumNFT"
