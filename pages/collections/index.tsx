...
import MyCollectionPageAdaptive from './adaptive/index-adaptive';
...
export default function MyCollectionPage() {
  ...
  return !isLoading ? (
    ...
    <>
      <Head>
        <title>GOLDOR | {t('collections.myCollections')}</title>
      ...
      <AppContainer>
        {!matchesDesktop ? (
          <MyCollectionPageAdaptive></MyCollectionPageAdaptive>
        ) : (
          <div className="content-page">
            ...
            <div className="content-page__content">
              ...
              <div className="create-collection-banner">
                <div className="create-collection-banner__title">
                  {t('collections.createNewCollection')}
                </div>
                <div className="create-collection-banner__description">
