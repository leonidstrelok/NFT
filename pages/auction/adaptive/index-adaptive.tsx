...
export default function AuctionPageAdaptive() {
        ...
        <div className="content-page__mobile__header">
          <div className="content-page__mobile__header__chart">
            ...
            <div className="content-page__mobile__description">
              {t('auction.descriptionAuction')}
            </div>
          </div>
        </div>
        <div className="content-page__mobile__content__auction">
          ...
          <div className="content-page__mobile__count-items">
            {getFilterAuctionItems.length % 10 === 1
              ? `${getFilterAuctionItems.length} ${t('nfts.item')}`
              : `${getFilterAuctionItems.length} ${t('nfts.items')}`}
          </div>
