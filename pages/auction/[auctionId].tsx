...
import AuctionItemPageAdaptive from './adaptive/auction-adaptive-id';
...
const AuctionItemPage: React.FC = () => {
  ...
  }, [auctionId, eventTime, metaplex, receiptAddress, wallet]);
          ...
          {!matchesDesktop ? (
            ...
            <>
              ...
              <div className="content-page auction-item-page">
                <div className="auction-item-page__content">
                  ...
                  {/* <Button onClick={finished}>Пополнить</Button> */}
                          ...
                          >
                            <TextField
                              ...
                              onChange={(e) => {
                                ...
                                if (Number(price) < 0) {
                                  const listingPrice = formatAmount(
                                    listing.price,
                                  );

                                  e.target.value = listingPrice.replace(
                                    'SOL ',
                                    '',
                                  );
                                  setOfferPrice(0);
                                ...
                                bids.map((p) => {
                                  ...
                                  const newPrice = bidsPrice.replace(
                                    'SOL ',
                                    '',
                                  );
                                  if (price > newPrice) {
